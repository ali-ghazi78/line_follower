...
; 0000 024A //        Stop();
; 0000 024B //    else
; 0000 024C     Move(100-motor_speed,100+motor_speed);
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	SUB  R30,R16
	SBC  R31,R17
